    ...
    <div class="flex justify-center items-center min-h-screen bg-base-200">
      <div class="w-[600px] bg-base-100 shadow-xl">
        <div class="m-8 flex flex-col">
          <h2 class="text-xl text-title text-center pb-6 border-b-2 border-primary">Личный кабинет</h2>
          ...
          <div class="flex gap-x-8 my-6">
            <div class="flex flex-1 flex-col gap-4 my-auto">
              ...
              <span class="font-bold py-2 border-b-2 border-primary">Имя пользователя:</span>
            ...
            <div class="flex flex-1 flex-col gap-4">
              ...
              <span class="p-2 border-2 border-primary rounded-xl">{{ user.fullname }}</span>
              <span class="p-2 border-2 border-primary rounded-xl">{{ user.username }}</span>
